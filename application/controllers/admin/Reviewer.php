...
class Reviewer extends Operator_Controller
{
	...
	public function index($page = null)
	{
        ...
        $pagination = $this->reviewer->makePagination(site_url($this->role . '/' . $this->pages), 3, $total);
	...
	$reviewer = $this->reviewer->where('reviewer_id', $id)->get();
        ...
        $pagination = $this->reviewer->makePagination(site_url('admin/reviewer/search/'), 3, $total);
