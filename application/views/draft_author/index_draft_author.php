            ...
            <table class="awn-table">
                ...
                <tbody>
                    ...
                    <?= ($i & 1) ? '<tr class="zebra">' : '<tr>'; ?>
                        ...
                        <td><?= anchor("draft_author/edit/$draft_author->draft_author_id", 'Edit', ['class' => 'btn btn-warning']) ?></td>
                        <td>
                            <?= form_open("draft_author/delete/$draft_author->draft_author_id") ?>
...
<div class="row">
    <!-- Button add -->
    <div class="col-2">
        <?= anchor("draft_author/add", 'Add', ['class' => 'btn btn-primary']) ?>
    </div>
